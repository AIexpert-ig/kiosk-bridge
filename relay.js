...
async function dispatchNotifications(data, source) {
  ...
  var pax       = data.pax      || 'Not specified';
  var timestamp = getDubaiTime();
  source = source || data.source || 'voice-ai';
  ...
  var emailHtml = '<h2>New Kiosk Booking</h2>'
    ...
    + '<tr><td style="padding:6px 12px;font-weight:bold">Pax</td><td style="padding:6px 12px">'     + pax       + '</td></tr>'
